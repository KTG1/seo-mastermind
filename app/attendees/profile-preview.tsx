...
export default function ProfilePreview({ name, initials, role, location, focus }: ProfilePreviewProps) {
  return <main className={styles.attendeePage}>
    <header className="attendeeHeader"><Link className="wordmark attendeeWordmark" href="/"><BrandMark /><span>HOLISTIC SEO<br />MASTERMIND</span></Link><nav aria-label="Primary navigation" style={{ display: "flex", gap: 18, marginLeft: 0 }}><Link href="/about/">About</Link><Link href="/agency/">Agency</Link><Link href="/course/">Course</Link><Link href="/founder/">Founder</Link><AgendaMenu /><Link href="/attendees/">Members</Link></nav><Link href="/tickets/#application">Request a seat <b>↗</b></Link></header>
