...
export type NavigationIconName = "about" | "agenda" | "venue" | "landmark" | "village" | "agency" | "course" | "founder" | "members" | "profile" | "ticket" | "faq" | "arrow";
...
const iconDetails: Record<NavigationIconName, { title: string; description: string; paths: ReactNode }> = {
  ...
  profile: { title: "Attendee profile", description: "A profile card representing an individual member page.", paths: <><rect x="3" y="3" width="14" height="14" rx="1" /><circle cx="8" cy="8" r="2" /><path d="M5.5 14c.7-2 1.6-3 2.5-3s1.8 1 2.5 3M12 8h2.5M12 11h2.5" /></> },
